...
CFLAGS=$(echo " -D_REENTRANT" | sed "s#$prefix#$prefix_real#")
VERSION="3.9"
LIBM="-lm"
LIBC=""
SYSLIBS="$LIBM $LIBC"
ABIFLAGS=""
LIBS=" -lsocket -lnsl -lintl -ldl -lsendfile  -lm $SYSLIBS"
LIBS_EMBED="-lpython${VERSION}${ABIFLAGS} -lsocket -lnsl -lintl -ldl -lsendfile  -lm $SYSLIBS"
BASECFLAGS=""
