...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'cc -G -L/opt/local/lib -I/opt/csw/include -L/opt/csw/lib  '
              '-R/opt/csw/lib',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'i386-pc-solaris2.11',
 'BYTESTR_DEPS': '\\',
 'CC': 'cc',
 'CCSHARED': '-Kpic',
 'CFLAGS': '-DNDEBUG -O -D_REENTRANT',
 'CFLAGSFORSHARED': '',
 'CFLAGS_ALIASING': '',
 'CFLAGS_NODIST': '',
 ...
 'CONFIGURE_CPPFLAGS': '-L/opt/local/lib -I/opt/csw/include -L/opt/csw/lib  '
                       '-R/opt/csw/lib',
 'CONFIGURE_LDFLAGS': '-L/opt/local/lib -I/opt/csw/include -L/opt/csw/lib  '
                      '-R/opt/csw/lib',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIG_ARGS': "'--with-openssl=/opt/csw/' 'ax_cv_c_float_words_bigendian=no' "
                "'LDFLAGS=-L/opt/local/lib -I/opt/csw/include -L/opt/csw/lib  "
                "-R/opt/csw/lib' "
                "'PKG_CONFIG_PATH=/opt/csw/lib/amd64/pkgconfig/' "
                "'CPPFLAGS=-L/opt/local/lib -I/opt/csw/include -L/opt/csw/lib  "
                "-R/opt/csw/lib'",
 'CONFINCLUDEDIR': '/usr/local/include',
 'CONFINCLUDEPY': '/usr/local/include/python3.9',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/export/home/lit/src/Python-3.9.19/coverage.info',
 'COVERAGE_REPORT': '/export/home/lit/src/Python-3.9.19/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include -L/opt/local/lib -I/opt/csw/include '
 ...
 'HAVE_ZLIB_COPY': 1,
 'HAVE__GETPTY': 0,
 'HOST_GNU_TYPE': 'i386-pc-solaris2.11',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'cc -G -L/opt/local/lib -I/opt/csw/include -L/opt/csw/lib  '
             '-R/opt/csw/lib',
 'LDVERSION': '3.9',
 'LIBC': '',
 ...
 'LIBS': '-lsocket -lnsl -lintl -ldl -lsendfile  -lm',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/opt/csw//include',
 'OPENSSL_LDFLAGS': '-L/opt/csw//lib',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-DNDEBUG -O -D_REENTRANT -I./Include/internal '
                             '-I. -I./Include -L/opt/local/lib '
                             '-I/opt/csw/include -L/opt/csw/lib  '
                             '-R/opt/csw/lib -DPy_BUILD_CORE_BUILTIN',
 'PY_CFLAGS': '-DNDEBUG -O -D_REENTRANT',
 'PY_CFLAGS_NODIST': '-I./Include/internal',
 'PY_COERCE_C_LOCALE': 1,
 'PY_CORE_CFLAGS': '-DNDEBUG -O -D_REENTRANT -I./Include/internal -I. '
                   '-I./Include -L/opt/local/lib -I/opt/csw/include '
                   '-L/opt/csw/lib  -R/opt/csw/lib -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-L/opt/local/lib -I/opt/csw/include -L/opt/csw/lib  '
                    '-R/opt/csw/lib',
 'PY_CPPFLAGS': '-I. -I./Include -L/opt/local/lib -I/opt/csw/include '
                '-L/opt/csw/lib  -R/opt/csw/lib',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/opt/local/lib -I/opt/csw/include -L/opt/csw/lib  '
               '-R/opt/csw/lib',
 'PY_LDFLAGS_NODIST': '',
 'PY_SSL_DEFAULT_CIPHERS': 1,
 'PY_SSL_DEFAULT_CIPHER_STRING': 0,
 'PY_STDMODULE_CFLAGS': '-DNDEBUG -O -D_REENTRANT -I./Include/internal -I. '
                        '-I./Include -L/opt/local/lib -I/opt/csw/include '
                        '-L/opt/csw/lib  -R/opt/csw/lib',
 'Py_DEBUG': 0,
 'Py_ENABLE_SHARED': 0,
 ...
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 'SHLIBS': '-lsocket -lnsl -lintl -ldl -lsendfile  -lm',
 'SHLIB_SUFFIX': '.so',
 'SHM_NEEDS_LIBRT': 0,
 ...
 'abs_builddir': '/export/home/lit/src/Python-3.9.19',
 'abs_srcdir': '/export/home/lit/src/Python-3.9.19',
